...
let
  ...
  perCompiler = {
    ghc910 = let haskellPackages = nixpkgs.haskell.packages.ghc910; in {
      cabal-fmt = nixpkgs.haskell.packages.ghc910.cabal-fmt;
      ghcide = nixpkgs.haskell.packages.ghc910.ghcide;
      doctest = nixpkgs.haskell.packages.ghc910.doctest;
      ...
      implicit-hie = nixpkgs.haskell.packages.ghc910.implicit-hie;
      hoogle = nixpkgs.haskell.packages.ghc910.hoogle;
      hpack = nixpkgs.haskell.packages.ghc910.hpack;
      haskell-language-server = nixpkgs.haskell.packages.ghc910.haskell-language-server;
      hasktags = nixpkgs.haskell.packages.ghc910.hasktags;
      ...
      stan = nixpkgs.haskell.packages.ghc910.stan;
    };
    ghc912 = let haskellPackages = nixpkgs.haskell.packages.ghc912; in {
      ...
      haskell-language-server = nixpkgs.haskell.packages.ghc910.haskell-language-server;
      hasktags = nixpkgs.haskell.packages.ghc910.hasktags;
      ghci-dap = nixpkgs.haskell.packages.ghc910.ghci-dap;
      haskell-debug-adapter = nixpkgs.haskell.packages.ghc910.haskell-debug-adapter;
      cabal-install = nixpkgs.haskell.packages.ghc910.cabal-install; # TODO: 3.14.1.0
      stack = lib.doJailbreak nixpkgs.haskell.packages.ghc98.stack; # 2024-11-09 not ready yet
      hlint = nixpkgs.haskell.packages.ghc98.hlint; # 2024-11-09 not ready yet
      weeder = lib.dontCheck (lib.doJailbreak nixpkgs.haskell.packages.ghc910.weeder); # 2024-11-09 not ready yet
      apply-refact = nixpkgs.haskell.packages.ghc98.apply-refact; # 2024-11-09 not ready yet
      # https://github.com/haskell-fswatch/hfsnotify/issues/115
      ghcid = nixpkgs.haskell.packages.ghc98.ghcid;
      stan = nixpkgs.haskell.packages.ghc910.stan;
